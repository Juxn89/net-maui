...
## Documentación
### Introducción
- [Primeros Pasos](https://learn.microsoft.com/es-es/dotnet/communitytoolkit/maui/get-started?tabs=CommunityToolkitMaui)
- [Guía de arquitectura de .NET MAUI](https://dotnet.microsoft.com/es-es/learn/maui/architecture)
- [¿Qué es .NET MAUI?](https://learn.microsoft.com/es-es/dotnet/maui/what-is-maui?view=net-maui-6.0)
